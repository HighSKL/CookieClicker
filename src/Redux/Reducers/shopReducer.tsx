...
const initialState = {
    products: [
        {id: 90239023, name: "Протеин", cost: 100, img: "https://www.profitness.fr/wp-content/uploads/2014/08/303-thickbox_default-complete-protein.jpg", description: "+2 к нажатию", effect: 2},
        {id: 90239024, name: "Сырный читос", cost: 60, img: "https://avatars.mds.yandex.net/get-mpic/5330487/img_id1981251420403652347.jpeg/orig", description: "+1 к нажатию", effect: 1},
